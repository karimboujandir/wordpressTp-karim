...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'Boujandirkarim_tpvoyage_b0a0c2edaef51d874045_20230206124604_archive.zip';
        const ARCHIVE_SIZE       = '42955917';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'b0a0c2e-06124604';
        const SECONDARY_PACKAGE_HASH = 'b514341-06124604';
